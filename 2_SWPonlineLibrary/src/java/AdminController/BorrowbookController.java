...
public class BorrowbookController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        BorrowbookDBContext db = new BorrowbookDBContext();
        List<Borrowbook> list = db.getborrowbook();
        ...
        //quantitystudent
            ...
            //quantityorderbook
            List<quantityorderbook> listo = db.getquantityorderbook();
            //quantityfeedback
        ...
        request.getRequestDispatcher("examples/borrowbook.jsp").forward(request, response);
    }else{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.sendRedirect("historyborrowbook");
    }
