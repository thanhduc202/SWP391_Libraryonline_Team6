...
//        Account list = db.getAccountByID(id);
//       
...
//        request.getRequestDispatcher("edit.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String aphone = request.getParameter("phonenumber");
        String astatus = request.getParameter("status");
        String aaccesslevel = request.getParameter("accesslevel");

        ManageUserDBContext db = new ManageUserDBContext();
        db.EditUser(aname, apass, afullname, agender, aphone, astatus, aaccesslevel, id);
