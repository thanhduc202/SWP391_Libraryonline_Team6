...
<html>  
    ...
    <body>  
        ...
        <div class="container">  
            ...
            <div class="d-flex"> 
                <form action="getRenewal2" method="post">
                    <label for="name">Account Name</label>
                    <input readonly="true" type="text" id="txtname" name="name" value="${sessionScope.account.accountName}">
                    <br/>
                    <label> Extend Date  </label> 
                    <input type="date"  name="edate" id="txtedate" min="2000-01-01" />
                    <br/>
                    <br/>

                    <label for="reason">Reason</label>
                    <textarea id="txtreason" name="reason" placeholder="Write reason.." style="width: 1000px; height: 200px"></textarea>
