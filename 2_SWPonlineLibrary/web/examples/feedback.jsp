...
<%-- 
    Document   : feedback
    Created on : Feb 28, 2023, 12:32:09 AM
    Author     : win
--%>
    ...
    <body class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="feedback">VIEW FEEDBACK</a>
                    <!-- Form -->
                    <!-- User -->
                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0">
                                <h3 class="mb-0">FEEDBACK ALL USER</h3>
                            </div>
                                                ...
                                                <th scope="row">
                                                    <div class="media align-items-center">
                                                        <div class="media-body">
                                                            <span class="mb-0 text-sm">${i.studentID}</span>
                                                        </div>
                                                    </div>
                                                </th>
                                                <td>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <button type="button"  title="Copy to clipboard">
                                                                <div>
                                                                    <a href="deletefeedback?fid=${i.studentID}"><i class="ni ni-lock-circle-open"></i></a>
                                                                </div>
                                                            </button>
                                                        </div>
                                                    </div>
