<%-- 
    Document   : returns
    Created on : Feb 22, 2023, 11:31:54 PM
    Author     : tient
--%>
                                                    ...
                                                    <c:forEach items="${listOrder}" var="listo">
                                                        <tr>
                                                            ...
                                                            <td class="font-weight-medium">
                                                                <div class=" text-white badge ${listo.status.statusName == 'Pending' || listo.status.statusId == 2 || listo.status.statusId == 3?'badge-warning':''}${listo.status.statusName == 'Received'?'badge-success':''}${listo.status.statusName == 'Overdue'?'badge-danger':''}">
                                                                    ${listo.status.statusId == 2 || listo.status.statusId == 3?'Pending':listo.status.statusName}
                                                                </div>
                                                            </td>
                                                            <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Ordered Date</label>
                                                                <div class="col-sm-9">
                                                                    <input type="date" class="form-control" disabled="" value="${listo.orderDate}"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="date" class="form-control" disabled="" value="${listo.scheduledTime}"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <form action="book_rental" method="post">
                                                                        <input type="text" name="action" hidden="" value="return">
                                                                        <input type="text" name="oid" hidden="" value="${listo.orderID}">
                                                                        <select class="form-control" name="sid" onchange="this.form.submit()" style="color: white; background-color: ${listo.status.statusName == 'Pending' || listo.status.statusId == 2 || listo.status.statusId == 3?'#FFC100':''}${listo.status.statusName == 'Received'?'green':''}${listo.status.statusName == 'Overdue'?'red':''}">
                                                                            <option style="color: white; background-color: #FFC100" value="1" ${listo.status.statusId == 1 || listo.status.statusId == 2 || listo.status.statusId == 3?'selected':''}>Pending</option>
                                                                            <c:if test="${listo.scheduledTime > dateNow}">
                                                                                <option style="color: white; background-color: red" value="4" ${listo.status.statusId == 4?'selected':''}>Overdue</option>
                                                                            </c:if>
                                                                            <option style="color: white; background-color: green" value="5" ${listo.status.statusId == 5?'selected':''}>Received</option>
                                                                        </select>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <c:forEach items="${listo.listOrderDetail}" var="listod">
                                                                    <tr>
                                                                        ...
                                                                        <td><label class="badge badge ${
                                                                                   listo.status.statusName == 'Pending' || listo.status.statusId == 2 || listo.status.statusId == 3?'badge-warning':''
                                                                                       }${listo.status.statusName == 'Received'?'badge-success':''}${listo.status.statusName == 'Overdue'?'badge-danger':''}">
