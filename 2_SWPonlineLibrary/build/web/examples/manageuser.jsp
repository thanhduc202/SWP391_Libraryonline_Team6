...
<%-- 
    Document   : manageuser
    Created on : Feb 23, 2023, 1:39:35 AM
    Author     : win
--%>
    ...
    <body  class="">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="ManageUser">MANAGE USER</a>
                    <!-- Form -->
                    <!-- User -->
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <span class="h2 font-weight-bold mb-0">${b.quantity} BOOK</span>
                                                </div>
                                                <div class="col-auto">
                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0">
                                <h3 class="mb-0">INFORMATION ALL USER</h3>
                            </div>
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <div>
                                                    <a href="add.jsp"class="ni ni-fat-add">ADD</a>          
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>
                                                ...
                                                <th scope="row">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="mb-0 text-sm">${o.fullname}</span>
                                                        </div>
                                                    </div>
                                                </th>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="avatar-group">
                                                        <button type="button" title="Copy to clipboard">
                                                            ...
                                                            <div>
                                                                <a href="loadAccount?Aid=${o.aid}"><i class="ni ni-scissors"></i></a>
                                                            </div>
                                                        </button>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <button type="button"  title="Copy to clipboard">
                                                                <div>
                                                                    <a href="deleteuser?Aid=${o.aid}"><i class="ni ni-fat-remove"></i></a>
                                                                </div>
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <button type="button"  title="Copy to clipboard">
                                                                <div>
                                                                    <a href="Loadstatususer?Aid=${o.aid}"><i class="ni ni-lock-circle-open"></i></a>
                                                                </div>
                                                            </button>
                                                        </div>
                                                    </div>
