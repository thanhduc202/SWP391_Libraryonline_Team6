...
<%-- 
    Document   : borrowbook
    Created on : Feb 28, 2023, 4:11:49 PM
    Author     : win
--%>
...
<html>
    <head>
        ...
        <title>
            Library - View History borrow book
        </title>
        <!-- Favicon -->
    ...
    <body class="">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <div class="navbar-collapse-header d-md-none">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="examples/borrowbook.jsp">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  active " href="historyborrowbook">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="historyborrowbook">View History Borrow Book</a>
                    <!-- Form -->
                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0">
                                <h3 class="mb-0">History borrow book</h3>
                            </div>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="media align-items-center">
                                                        <div class="media-body">
                                                            <span class="mb-0 text-sm">${b.aname}</span>
                                                        </div>
                                                    </div>
                                                </th>
                                                <td>
                                                ...
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        <i class="bg-warning"></i> ${b.statusname}
                                                    </span>
                                                </td>
                                                <td>
