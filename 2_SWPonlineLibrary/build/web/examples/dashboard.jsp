...
<%-- 
    Document   : dashboard
    Created on : Feb 28, 2023, 11:18:33 PM
    Author     : win
--%>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">ReceivedOn</th>
                                        <th scope="col">ReturnOn</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">ID</th>
                                        <th scope="col">LibrarianID</th>
                                        <th scope="col">ExtendDate</th>
                                        <th scope="col">Reason</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach var="r" items="${List4}">
                                    <tr>   
                                        <th scope="row">
                                        </th>
                                        <td>
                ...
                <div class="col-xl-4">
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="mb-0">NAME ALL ACCOUNT IN SYSTEM</h3>
                                </div>
                                <div class="col text-right">
                                    <a href="#!" class="btn btn-sm btn-primary">See all</a>
                                </div>
